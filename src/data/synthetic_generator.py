...
def _with_natural_tail(source: str, target: str, index: int) -> tuple[str, str]:
    tails = (
        ...
        "После проверки редактор уточнил справку.",
        "Вечером комиссия открыла ведомость.",
        "Затем аналитик согласовал приказ.",
        "Позже секретарь сохранил протокол.",
        "Утром группа проверила таблицу.",
        "После встречи юрист обновил журнал.",
        "Вечером служба закрыла заявку.",
        "Затем автор сверил список.",
        "Позже отдел принял договор.",
        "Утром координатор отправил ответ.",
        "После обеда редакция уточнила маршрут.",
        "Вечером эксперт сохранил ведомость.",
        "Затем комиссия проверила папку.",
        "Позже аналитик открыл протокол.",
        "Утром секретарь согласовал справку.",
        "После проверки юрист принял таблицу.",
        "Вечером группа обновила договор.",
        "Затем служба сверила приказ.",
        "Позже автор сохранил журнал.",
        "Утром редактор закрыл заявку.",
        "После встречи отдел уточнил список.",
        "Вечером координатор проверил протокол.",
        "Затем эксперт отправил справку.",
        "Позже комиссия обновила маршрут.",
        "Утром аналитик принял ведомость.",
        "После обеда секретарь открыл договор.",
        "Вечером юрист сохранил приказ.",
        "Затем редакция сверила таблицу.",
        "Позже группа согласовала список.",
        "Утром служба проверила журнал.",
        "После проверки автор обновил протокол.",
        "Вечером отдел отправил справку.",
        "Затем координатор уточнил ведомость.",
        "Позже эксперт принял договор.",
        "Утром комиссия сохранила приказ.",
        "После встречи аналитик закрыл заявку.",
        "Вечером секретарь сверил маршрут.",
        "Затем юрист проверил таблицу.",
        "Позже редактор обновил список.",
        "Утром отдел согласовал протокол.",
        "После обеда служба открыла справку.",
        "Вечером автор принял ведомость.",
        "Затем группа сохранила договор.",
        "Позже координатор сверил приказ.",
        "Утром эксперт уточнил журнал.",
        "После проверки комиссия отправила таблицу.",
        "Вечером аналитик обновил маршрут.",
        "Затем секретарь принял список.",
        "Позже юрист открыл протокол.",
        "Утром редакция сохранила справку.",
        "После встречи автор сверил ведомость.",
        "Вечером служба согласовала договор.",
        "Затем отдел проверил приказ.",
        "Позже эксперт обновил заявку.",
        "Утром координатор закрыл журнал.",
        "После обеда группа уточнила таблицу.",
        "Вечером комиссия приняла список.",
        "Затем аналитик сохранил маршрут.",
        "Позже секретарь отправил договор.",
        "Утром юрист обновил справку.",
        "После проверки редактор сверил ведомость.",
        "Вечером отдел открыл протокол.",
        "Затем служба приняла приказ.",
        "Позже автор согласовал список.",
        "Утром эксперт сохранил таблицу.",
        "После встречи координатор проверил справку.",
        "Вечером группа отправила журнал.",
        "Затем комиссия обновила договор.",
        "Позже аналитик закрыл вопрос.",
        "Утром секретарь уточнил приказ.",
    )
