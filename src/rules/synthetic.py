...
TARGETED_BACKFILL_PAIR_TEMPLATES: dict[str, tuple[tuple[str, str], ...]] = {
    ...
    "hyphen_po_adverbs": (
        ...
        ("Автор сделал отчет по новому.", "Автор сделал отчет по-новому."),
        ("Редактор ответил по дружески утром.", "Редактор ответил по-дружески утром."),
        ("Команда работала по старому.", "Команда работала по-старому."),
    ),
    "pol_polu_compounds": (
...
TARGETED_BACKFILL_TERM_BANK: dict[str, tuple[str, ...]] = {
    ...
    "missing_hard_sign": ("объявление", "подъезд", "съезд", "объект", "разъяснение", "объем"),
    "soft_to_hard_sign": ("объявление", "подъезд", "съезд", "объект", "разъяснение", "объем"),
    "sdelat_prefix": ("сделать", "сделал", "сделали", "сделано", "сделка", "сдержать"),
    "prefix_z_to_s": ("бесполезный", "рассказать", "исправить", "воскликнуть", "ниспадать", "вспомнить"),
    "prefix_s_to_z": ("бездарный", "разбудить", "издалека", "возглавить", "взлететь", "низвергнуть"),
    ...
    "pattern_жы_жи": ("жизнь", "житель", "пружина", "животное"),
    "pattern_шы_ши": ("машина", "ширина", "тишина", "ошибка"),
    "pattern_чя_ча": ("часть", "чайник", "начало", "задача"),
    "pattern_щя_ща": ("щавель", "площадь", "прощание", "обещание"),
    "pattern_щю_щу": ("щука", "щуплый", "щуриться", "щупальце"),
    "pattern_чю_чу": ("чудо", "чувство", "чужой", "чулан"),
    "pattern_цы_ци": ("цифра", "цирк", "цитата", "лекция"),
    "pattern_жо_же": ("желтый", "жесткий", "железо", "жевать"),
    "pattern_шо_ше": ("шестой", "шелест", "шепот", "шелковый"),
    "pattern_чо_че": ("черный", "чертеж", "человек", "честный"),
    "pattern_що_ще": ("щедрый", "щетка", "щенок", "ущелье"),
    "n_nn_adjective": ("длинный", "ценный", "странный", "юный"),
    "n_nn_participle": ("подписанный", "проверенный", "согласованный", "прочитанный"),
    "n_nn_deverbal_adjective": ("жареный", "ветреный", "раненый"),
    "n_nn_short_form": ("уверены", "подготовлены", "проверены", "согласованы"),
    "tsya_soft_delete": ("учится", "готовится", "строится", "вернется", "останется", "кажется"),
}
