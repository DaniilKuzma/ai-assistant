...
def _template_pair(rule_id: str, index: int) -> PairTemplate | None:
    ...
    templates: dict[str, tuple[PairTemplate, ...]] = {
        ...
        "ne_short_form": (
            ...
            PairTemplate("Вывод не понятен комиссии.", "Вывод непонятен комиссии."),
        ),
        "ne_predicative": (
            PairTemplate("Это не возможно для отдела.", "Это невозможно для отдела."),
            PairTemplate("Это не понятно комиссии.", "Это непонятно комиссии."),
        ),
        "ni_stable_expression": (
        ...
        "n_nn_short_form": (
            ...
            PairTemplate("Данные проверенны.", "Данные проверены."),
        ),
        "tsya_soft_insert": (
