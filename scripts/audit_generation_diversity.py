...
def main() -> int:
    ...
    print("rule_id distribution:")
    print(json.dumps(audit["rule_distribution"], ensure_ascii=False, sort_keys=True))
    print("sub_rule_id distribution:")
    print(json.dumps(diversity["sub_rule_distribution"], ensure_ascii=False, sort_keys=True))
    print("mode distribution:")
    print(json.dumps(audit["mode_distribution"], ensure_ascii=False, sort_keys=True))
    print("duplicate rate per layer:")
    print(json.dumps(diversity["duplicate_rate_by_layer"], ensure_ascii=False, sort_keys=True))
    print("top duplicates:")
    print(json.dumps(diversity["top_duplicate_pairs"], ensure_ascii=False, sort_keys=True))
    print("diversity:")
