# Final Threshold Update Report v3
...
- v3 keeps the v2 threshold values and relies on stricter lexical validation guards.
...
Audit: `reports/eval_test_calibrated_v2_short_v2/clean_fp_dictionary_swapped_audit.csv`
...
Profile: `calibrated_val_guarded_v3`
...
Report dir: `reports/eval_val_calibrated_v3_short_v2`
...
Report dir: `reports/eval_test_calibrated_v3_short_v2`
...
- Config updated: yes
- Backup: `configs/config.yaml.bak_before_threshold_update_v3_20260520_214323`
- Active mode: `calibrated_val_guarded_v3`
