...
- accepted_clean_sentences: 262167
...
|---|---|---|---|---|---:|---:|---:|---:|---|---|---|
| lenta_news | loaded | local | data\external\lenta-ru-news.csv.bz2 | https://github.com/yutkin/Lenta.Ru-News-Dataset/releases/download/v1.1/lenta-ru-news.csv.bz2 | 346031300 | 151403 | 150000 | 1403 |  | Public Lenta.ru news dataset; verify before production use. | True |
| nerus_news | loaded | local | data\external\nerus_lenta.conllu.gz | https://storage.yandexcloud.net/natasha-nerus/data/nerus_lenta.conllu.gz | 1961465886 | 122042 | 120000 | 2042 |  | Nerus Lenta annotated corpus; verify before production use. | True |
